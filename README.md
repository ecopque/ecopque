...
| **Language** | **Category**                          | **Packages**                                                                                                                                                                                         | **Description**                                                                 |
| ------------ | ------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| Python       | 🧮 Scientific and Numerical Computing | `numpy`, `math`, `decimal`                                                                                                                                                                           | Libraries for numerical operations, scientific computing, and precise math.     |
| Python       | 📊 Data Analysis and Manipulation     | `pandas`                                                                                                                                                                                             | Tools for data manipulation, cleaning, and analysis.                            |
| Python       | 🗃️ Database and ORM                  | `pymysql`, `sqlite3`, `sqlalchemy`, `django`, `cursors`                                                                                                                                              | Database connectors and ORMs for relational database interaction.               |
| Python       | 🌐 Web Scraping and HTTP Requests     | `requests`, `bs4`, `BeautifulSoup`                                                                                                                                                                   | Handling HTTP requests and extracting content from web pages.                   |
| Python       | 📧 Email Handling                     | `email.mime.multipart`, `email.mime.text`, `smtplib`                                                                                                                                                 | Modules for creating and sending emails via SMTP.                               |
| Python       | 📂 File and Directory Management      | `os`, `pathlib`, `shutil`, `zipfile`                                                                                                                                                                 | Manage files, directories, and compression.                                     |
| Python       | 🧪 Parsing and Text Processing        | `re`, `json`, `csv`, `string`, `locale`                                                                                                                                                              | Parsing strings, working with structured data and localization.                 |
| Python       | 🕓 Date and Time                      | `datetime`, `calendar`, `pytz`, `dateutil`                                                                                                                                                           | Manipulating dates, times, and time zones.                                      |
| Python       | 🔐 Security and Hashing               | `secrets`, `hashlib`                                                                                                                                                                                 | Secure random generation and hashing algorithms.                                |
| Python       | 🧠 Standard Library Utilities         | `sys`, `importlib`, `copy`, `itertools`, `functools`, `types`, `pprint`, `abc`, `contextlib`, `enum`, `dataclasses`, `collections`, `typing`, `argparse`, `subprocess`, `time`, `sleep`, `threading` | Utility modules for functional programming, type hints, processes, and threads. |
| Python       | 🧪 Environment and Configuration      | `dotenv`                                                                                                                                                                                             | Load environment variables from a `.env` file.                                  |
| Python       | 📊 PDF and Excel Processing           | `pypdf2`, `openpyxl`                                                                                                                                                                                 | Read and write PDF or Excel files.                                              |
| Python       | 🎨 GUI and Visual Components          | `pil`, `pyside6`, `qdarktheme`                                                                                                                                                                       | Create graphical interfaces and manage image/visual themes.                     |
| Python       | ⚙️ Custom or Project-Specific Modules | `utils`, `log`, `adtv2`, `Q`                                                                                                                                                                         | Project-specific logic or internal helper modules.                              |
